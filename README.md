...
Realizar entrada e validação de dados robusta com TryParse.

Utilizar estruturas de repetição (do-while) e decisão (switch/case).
...
Listar Exercícios: Exibição formatada de todos os itens cadastrados.

Buscar por Nome: Localização rápida de um exercício específico.

Filtrar por Grupo Muscular: Lista apenas exercícios de uma categoria (ex: Peito, Costas).

Calcular Carga Total: Soma de todas as cargas cadastradas no treino.

Exibir Mais Pesado: Identifica o exercício com a maior carga.
...
Bibliotecas: System.Linq, System.Collections.Generic
